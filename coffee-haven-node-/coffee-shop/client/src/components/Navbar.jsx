        ...
        <div className="container-max px-4 sm:px-6 md:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <Link to="/" className="flex items-center gap-1.5 sm:gap-2 font-heading font-bold text-lg sm:text-xl text-primary flex-shrink-0">
              <img src="/logo.png" alt="Coffee Haven Logo" className="w-8 h-8 sm:w-10 sm:h-10 object-contain rounded-full" />
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    {user.avatar ? (
                      ...
                      <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-primary text-white flex items-center justify-center text-xs sm:text-sm font-bold">
