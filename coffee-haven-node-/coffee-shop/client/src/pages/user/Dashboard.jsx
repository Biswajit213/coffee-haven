...
export default function Dashboard() {
  ...
  const quickLinks = [
    ...
    { to: '/menu', icon: FiPackage, label: 'Shop Now', color: 'bg-amber-50 text-amber-600' },
  ];
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8 sm:py-10 text-gray-400">
              ...
              <Link to="/menu" className="btn-primary inline-block mt-3 sm:mt-4 text-sm">Browse Menu</Link>
            </div>
          ) : (
