        ...
        {cart.items.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-8">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="flex flex-col sm:flex-row items-end sm:items-center gap-2 sm:gap-3 flex-shrink-0">
                        ...
                        <div className="flex items-center gap-2">
                          <p className="font-bold text-dark text-sm sm:text-base w-14 text-right">${(item.price * item.quantity).toFixed(2)}</p>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm h-fit lg:sticky lg:top-20">
              ...
              <Link to="/menu" className="block text-center text-primary text-xs sm:text-sm mt-3 sm:mt-4 hover:underline">
                Continue Shopping
              </Link>
            </div>
          </div>
