...
const CATEGORIES = ['All', 'Espresso', 'Cappuccino', 'Latte', 'Mocha', 'Cold Coffee', 'Tea', 'Snacks', 'Desserts'];
const SORT_OPTIONS = [
    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="relative py-10 sm:py-14 md:py-16 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl sm:text-4xl font-heading font-bold text-white mb-2 sm:mb-3">Our Menu</h1>
          <p className="text-gray-300 max-w-md mx-auto text-sm sm:text-base">Explore our full range of premium coffees and more</p>
        </div>
      </div>
